...
const ReportSale = () => {
    ...
    const getAll = async (page) => {
        const resp = await axios.get(`${endpoint}${kitchenLink}/reports?page=${page}&limit=${itemsPerPage}`, {
            headers: headers,
            ...credentials
        });
        setDetays(resp.data.orders);
        setTotalPages(resp.data.totalPages);
    };

    const deleteProducts = async (id) => {
        await axios.delete(`${endpoint}${kitchenLink}/reports/${id}`, {
            headers: headers,
            ...credentials
        });
        getAll(currentPage);
    ...
    const exportToExcel = async () => {
        const resp = await axios.get(`${endpoint}${kitchenLink}/exportar`, {
            headers: headers,
            ...credentials
        });
        ...
        saveAs(data, "reportes_ventas.xlsx");
    };
    return (
        <div>
